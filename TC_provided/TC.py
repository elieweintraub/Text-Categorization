...
if __name__ == "__main__":
	...
	print '-------------------------------------------'
	train = input('Would you like to load in a previously trained system (0) or train the text categorization system with a new training set (1): ')
	if train:
